    ...
    return(
      <div>
        <Menu as='div' className='inline-block text-left'>
          <div className="flex">
            <Menu.Button className='inline-flex gap-2 rounded-md w-full bg-white md:px-4 py-2 text-sm font-medium text-slate-700 hover:bg-opacity-20'>
              ...
              <img 
              src={user?.profileurl} alt="user profile"
